...
* Advertised Window size: Each time the socket receives a packet from the other side, it will update the advertised window size based on the value in the tcpHeader.
